...
/** @addtogroup CMSDK_CM3_Definitions CMSDK_CM3 Definitions
  This file defines all structures and symbols for CMSDK_CM3:
...
/******************************************************************************/
/** @addtogroup CMSDK_CM3_CMSIS Device CMSIS Definitions
...
/******  CMSDK Specific Interrupt Numbers *******************************************************/
	 ...
	 RTC_IRQn            =  1, //  Real Time Clock
	 TIM0_IRQn           =  2, //  Timer0 / Timer1
	 TIM2_IRQn           =  3, //  Timer2 / Timer3
	 MCIA_IRQn           =  4, //  MCIa
	 MCIB_IRQn           =  5, //  MCIb
	 UART0_IRQn          =  6, //  UART0 - DUT FPGA
	 UART1_IRQn          =  7, //  UART1 - DUT FPGA
	 UART2_IRQn          =  8, //  UART2 - DUT FPGA
	 UART4_IRQn          =  9, //  UART4 - not connected
	 AACI_IRQn           = 10, // AACI / AC97
	 CLCD_IRQn           = 11, // CLCD Combined Interrupt
	 ENET_IRQn           = 12, // Ethernet
	 USBDC_IRQn          = 13, // USB Device
	 USBHC_IRQn          = 14, // USB Host Controller
	 CHLCD_IRQn          = 15, // Character LCD
	 FLEXRAY_IRQn        = 16, // Flexray
	 CAN_IRQn            = 17, // CAN
	 LIN_IRQn            = 18, // LIN
	 I2C_IRQn            = 19, // I2C ADC/DAC
	 CPU_CLCD_IRQn       = 28, // Reserved - CPU FPGA CLCD
	 UART3_IRQn          = 30, // UART3    - CPU FPGA
	 SPI_IRQn            = 31, // SPI Touchscreen - CPU FPGA
} IRQn_Type;
...
/*@}*/ /* end of group CMSDK_CM3_CMSIS */


#include "core_cm3.h"                     /* Cortex-M3 processor and core peripherals           */
#include "system_CMSDK_CM3.h"             /* CMSDK_CM3 System include file                      */


/******************************************************************************/
/*                Device Specific Peripheral registers structures             */
/******************************************************************************/
/** @addtogroup CMSDK_CM3_Peripherals CMSDK_CM3 Peripherals
  CMSDK_CM3 Device Specific Peripheral registers structures
  @{
*/
...
/*@}*/ /* end of group CMSDK_CM3_Peripherals */


/******************************************************************************/
/*                         Peripheral memory map                              */
/******************************************************************************/
/** @addtogroup CMSDK_CM3_MemoryMap CMSDK_CM3 Memory Mapping
  @{
*/
...
/*@}*/ /* end of group CMSDK_CM3_MemoryMap */


/******************************************************************************/
/*                         Peripheral declaration                             */
/******************************************************************************/
/** @addtogroup CMSDK_CM3_PeripheralDecl CMSDK_CM3 Peripheral Declaration
  @{
*/
#define EEPROM_BASE             ((volatile unsigned int *)(0x00002000))

#define RCM3_EEP_CTRL           ((volatile unsigned int *)(0x00020000 + 0x0))
#define RCM3_EEP_BYFB_LEN_ADDR  ((volatile unsigned int *)(0x00020000 + 0x4))
...
#define CM3SDK_SRAM             ((volatile unsigned int *)(0x20000000 + 0x0000))
#define TEST_END                ((volatile unsigned int *)(0x20000000 + 0xFFFC))
#define PASS_FAIL               ((volatile unsigned int *)(0x20000000 + 0xFFF8))
#define SIM_COUNT               ((volatile unsigned int *)(0x20000000 + 0xFFF4))

#define SSP0_CR0                ((volatile unsigned int *)(0x40003000 + 0x0000))
#define SSP0_CR1                ((volatile unsigned int *)(0x40003000 + 0x0004))
#define SSP0_DR                 ((volatile unsigned int *)(0x40003000 + 0x0008))
#define SSP0_SR                 ((volatile unsigned int *)(0x40003000 + 0x000C))
#define SSP0_CPSR               ((volatile unsigned int *)(0x40003000 + 0x0010))
#define SSP0_IMSC               ((volatile unsigned int *)(0x40003000 + 0x0014))
#define SSP0_RIS                ((volatile unsigned int *)(0x40003000 + 0x0018))
#define SSP0_MIS                ((volatile unsigned int *)(0x40003000 + 0x001C))
#define SSP0_ICR                ((volatile unsigned int *)(0x40003000 + 0x0020))
#define SSP0_MACR               ((volatile unsigned int *)(0x40003000 + 0x0024))

/* UART Registers*/
#define UART_BASE             ((volatile unsigned int *)(0x40007000))
#define UART_DR               ((volatile unsigned int *)(0x40007000 + 0x0000))
#define UART_RSR              ((volatile unsigned int *)(0x40007000 + 0x0004))
#define UART_ECR              ((volatile unsigned int *)(0x40007000 + 0x0004))
#define UART_FR               ((volatile unsigned int *)(0x40007000 + 0x0018))
#define UART_ILPR             ((volatile unsigned int *)(0x40007000 + 0x0020))
#define UART_IBRD             ((volatile unsigned int *)(0x40007000 + 0x0024))
#define UART_FBRD             ((volatile unsigned int *)(0x40007000 + 0x0028))
#define UART_LCR_H            ((volatile unsigned int *)(0x40007000 + 0x002C))
#define UART_CR               ((volatile unsigned int *)(0x40007000 + 0x0030))
#define UART_IFLS             ((volatile unsigned int *)(0x40007000 + 0x0034))
#define UART_IMSC             ((volatile unsigned int *)(0x40007000 + 0x0038))
#define UART_RIS              ((volatile unsigned int *)(0x40007000 + 0x003C))
#define UART_MIS              ((volatile unsigned int *)(0x40007000 + 0x0040))
#define UART_ICR              ((volatile unsigned int *)(0x40007000 + 0x0044))
#define UART_DMACR            ((volatile unsigned int *)(0x40007000 + 0x0048))
...
/*@}*/ /* end of group CMSDK_CM3_PeripheralDecl */

/*@}*/ /* end of group CMSDK_CM3_Definitions */
